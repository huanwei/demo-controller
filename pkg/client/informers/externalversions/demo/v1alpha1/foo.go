...
import (
	...
	versioned "github.com/huanwei/demo-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/huanwei/demo-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/huanwei/demo-controller/pkg/client/listers/demo/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DemoV1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DemoV1alpha1().Foos(namespace).Watch(options)
			},
		},
		&demov1alpha1.Foo{},
		resyncPeriod,
